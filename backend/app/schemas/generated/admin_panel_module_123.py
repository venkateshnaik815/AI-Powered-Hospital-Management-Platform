...
class AdminPanelModule123Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule123Create(AdminPanelModule123Base):
    pass

class AdminPanelModule123Response(AdminPanelModule123Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
