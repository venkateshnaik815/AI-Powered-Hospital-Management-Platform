...
class AdminPanelModule131Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule131Create(AdminPanelModule131Base):
    pass

class AdminPanelModule131Response(AdminPanelModule131Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
