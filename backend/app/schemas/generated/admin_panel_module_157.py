...
class AdminPanelModule157Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule157Create(AdminPanelModule157Base):
    pass

class AdminPanelModule157Response(AdminPanelModule157Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
