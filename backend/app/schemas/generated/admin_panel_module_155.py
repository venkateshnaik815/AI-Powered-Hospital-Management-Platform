...
class AdminPanelModule155Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule155Create(AdminPanelModule155Base):
    pass

class AdminPanelModule155Response(AdminPanelModule155Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
