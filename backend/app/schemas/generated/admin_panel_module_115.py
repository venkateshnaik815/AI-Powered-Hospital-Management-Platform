...
class AdminPanelModule115Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule115Create(AdminPanelModule115Base):
    pass

class AdminPanelModule115Response(AdminPanelModule115Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
