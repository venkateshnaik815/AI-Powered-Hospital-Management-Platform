...
class AdminPanelModule146Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule146Create(AdminPanelModule146Base):
    pass

class AdminPanelModule146Response(AdminPanelModule146Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
