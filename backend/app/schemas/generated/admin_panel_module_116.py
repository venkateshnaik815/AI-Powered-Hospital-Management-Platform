...
class AdminPanelModule116Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule116Create(AdminPanelModule116Base):
    pass

class AdminPanelModule116Response(AdminPanelModule116Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
