...
class AdminPanelModule151Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule151Create(AdminPanelModule151Base):
    pass

class AdminPanelModule151Response(AdminPanelModule151Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
