...
class AdminPanelModule119Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule119Create(AdminPanelModule119Base):
    pass

class AdminPanelModule119Response(AdminPanelModule119Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
