...
class AdminPanelModule122Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule122Create(AdminPanelModule122Base):
    pass

class AdminPanelModule122Response(AdminPanelModule122Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
