...
class AdminPanelModule134Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule134Create(AdminPanelModule134Base):
    pass

class AdminPanelModule134Response(AdminPanelModule134Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
