...
class AdminPanelModule103Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule103Create(AdminPanelModule103Base):
    pass

class AdminPanelModule103Response(AdminPanelModule103Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
