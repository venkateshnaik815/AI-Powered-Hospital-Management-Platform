...
class AdminPanelModule148Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule148Create(AdminPanelModule148Base):
    pass

class AdminPanelModule148Response(AdminPanelModule148Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
