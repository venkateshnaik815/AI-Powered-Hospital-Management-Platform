...
class AdminPanelModule140Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule140Create(AdminPanelModule140Base):
    pass

class AdminPanelModule140Response(AdminPanelModule140Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
