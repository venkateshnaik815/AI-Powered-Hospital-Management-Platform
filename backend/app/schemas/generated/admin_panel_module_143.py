...
class AdminPanelModule143Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule143Create(AdminPanelModule143Base):
    pass

class AdminPanelModule143Response(AdminPanelModule143Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
