...
class AdminPanelModule136Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule136Create(AdminPanelModule136Base):
    pass

class AdminPanelModule136Response(AdminPanelModule136Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
