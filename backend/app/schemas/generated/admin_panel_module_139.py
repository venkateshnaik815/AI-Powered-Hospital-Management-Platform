...
class AdminPanelModule139Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule139Create(AdminPanelModule139Base):
    pass

class AdminPanelModule139Response(AdminPanelModule139Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
