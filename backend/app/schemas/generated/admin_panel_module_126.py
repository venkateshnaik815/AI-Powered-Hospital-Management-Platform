...
class AdminPanelModule126Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule126Create(AdminPanelModule126Base):
    pass

class AdminPanelModule126Response(AdminPanelModule126Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
