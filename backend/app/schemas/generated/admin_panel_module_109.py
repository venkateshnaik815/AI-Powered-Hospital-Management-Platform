...
class AdminPanelModule109Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule109Create(AdminPanelModule109Base):
    pass

class AdminPanelModule109Response(AdminPanelModule109Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
