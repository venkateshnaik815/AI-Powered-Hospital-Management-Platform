...
class AdminPanelModule156Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule156Create(AdminPanelModule156Base):
    pass

class AdminPanelModule156Response(AdminPanelModule156Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
