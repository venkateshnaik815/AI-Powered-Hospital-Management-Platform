...
class AdminPanelModule105Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule105Create(AdminPanelModule105Base):
    pass

class AdminPanelModule105Response(AdminPanelModule105Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
