...
class AdminPanelModule110Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule110Create(AdminPanelModule110Base):
    pass

class AdminPanelModule110Response(AdminPanelModule110Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
