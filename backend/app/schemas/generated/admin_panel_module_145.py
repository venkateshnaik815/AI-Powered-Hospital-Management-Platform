...
class AdminPanelModule145Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule145Create(AdminPanelModule145Base):
    pass

class AdminPanelModule145Response(AdminPanelModule145Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
