...
class AdminPanelModule121Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule121Create(AdminPanelModule121Base):
    pass

class AdminPanelModule121Response(AdminPanelModule121Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
