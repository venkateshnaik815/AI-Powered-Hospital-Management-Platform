...
class AdminPanelModule158Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule158Create(AdminPanelModule158Base):
    pass

class AdminPanelModule158Response(AdminPanelModule158Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
