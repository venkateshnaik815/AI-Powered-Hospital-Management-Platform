...
class AdminPanelModule117Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule117Create(AdminPanelModule117Base):
    pass

class AdminPanelModule117Response(AdminPanelModule117Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
