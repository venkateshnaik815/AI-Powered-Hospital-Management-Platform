...
class AdminPanelModule107Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule107Create(AdminPanelModule107Base):
    pass

class AdminPanelModule107Response(AdminPanelModule107Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
