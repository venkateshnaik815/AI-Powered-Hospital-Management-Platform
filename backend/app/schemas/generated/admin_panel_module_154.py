...
class AdminPanelModule154Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule154Create(AdminPanelModule154Base):
    pass

class AdminPanelModule154Response(AdminPanelModule154Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
