...
class AdminPanelModule150Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule150Create(AdminPanelModule150Base):
    pass

class AdminPanelModule150Response(AdminPanelModule150Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
