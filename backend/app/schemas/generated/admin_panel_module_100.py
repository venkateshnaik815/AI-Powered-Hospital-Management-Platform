...
class AdminPanelModule100Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule100Create(AdminPanelModule100Base):
    pass

class AdminPanelModule100Response(AdminPanelModule100Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
