...
class AdminPanelModule118Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule118Create(AdminPanelModule118Base):
    pass

class AdminPanelModule118Response(AdminPanelModule118Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
