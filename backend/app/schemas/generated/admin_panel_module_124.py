...
class AdminPanelModule124Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule124Create(AdminPanelModule124Base):
    pass

class AdminPanelModule124Response(AdminPanelModule124Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
