...
class AdminPanelModule137Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule137Create(AdminPanelModule137Base):
    pass

class AdminPanelModule137Response(AdminPanelModule137Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
