...
class AdminPanelModule111Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule111Create(AdminPanelModule111Base):
    pass

class AdminPanelModule111Response(AdminPanelModule111Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
