...
class AdminPanelModule120Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule120Create(AdminPanelModule120Base):
    pass

class AdminPanelModule120Response(AdminPanelModule120Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
