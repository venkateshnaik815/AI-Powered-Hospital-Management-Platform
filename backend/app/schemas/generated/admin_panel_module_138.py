...
class AdminPanelModule138Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule138Create(AdminPanelModule138Base):
    pass

class AdminPanelModule138Response(AdminPanelModule138Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
