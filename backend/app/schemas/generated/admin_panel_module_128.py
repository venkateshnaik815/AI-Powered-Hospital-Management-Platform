...
class AdminPanelModule128Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule128Create(AdminPanelModule128Base):
    pass

class AdminPanelModule128Response(AdminPanelModule128Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
