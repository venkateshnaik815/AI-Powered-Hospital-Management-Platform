...
class AdminPanelModule149Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule149Create(AdminPanelModule149Base):
    pass

class AdminPanelModule149Response(AdminPanelModule149Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
