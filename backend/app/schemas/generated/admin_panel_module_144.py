...
class AdminPanelModule144Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule144Create(AdminPanelModule144Base):
    pass

class AdminPanelModule144Response(AdminPanelModule144Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
