...
class AdminPanelModule112Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule112Create(AdminPanelModule112Base):
    pass

class AdminPanelModule112Response(AdminPanelModule112Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
