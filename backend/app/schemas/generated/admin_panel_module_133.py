...
class AdminPanelModule133Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule133Create(AdminPanelModule133Base):
    pass

class AdminPanelModule133Response(AdminPanelModule133Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
