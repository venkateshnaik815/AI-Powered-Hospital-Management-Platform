...
class AdminPanelModule106Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule106Create(AdminPanelModule106Base):
    pass

class AdminPanelModule106Response(AdminPanelModule106Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
