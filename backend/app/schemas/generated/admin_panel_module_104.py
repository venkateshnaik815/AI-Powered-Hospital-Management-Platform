...
class AdminPanelModule104Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule104Create(AdminPanelModule104Base):
    pass

class AdminPanelModule104Response(AdminPanelModule104Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
