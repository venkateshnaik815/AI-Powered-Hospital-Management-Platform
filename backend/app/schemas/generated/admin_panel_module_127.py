...
class AdminPanelModule127Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule127Create(AdminPanelModule127Base):
    pass

class AdminPanelModule127Response(AdminPanelModule127Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
