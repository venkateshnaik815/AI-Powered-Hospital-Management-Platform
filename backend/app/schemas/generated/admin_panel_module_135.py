...
class AdminPanelModule135Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule135Create(AdminPanelModule135Base):
    pass

class AdminPanelModule135Response(AdminPanelModule135Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
