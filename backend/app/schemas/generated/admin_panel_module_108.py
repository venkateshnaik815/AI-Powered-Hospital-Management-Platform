...
class AdminPanelModule108Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule108Create(AdminPanelModule108Base):
    pass

class AdminPanelModule108Response(AdminPanelModule108Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
