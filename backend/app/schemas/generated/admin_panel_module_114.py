...
class AdminPanelModule114Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule114Create(AdminPanelModule114Base):
    pass

class AdminPanelModule114Response(AdminPanelModule114Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
