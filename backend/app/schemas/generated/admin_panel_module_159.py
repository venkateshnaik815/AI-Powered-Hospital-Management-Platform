...
class AdminPanelModule159Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule159Create(AdminPanelModule159Base):
    pass

class AdminPanelModule159Response(AdminPanelModule159Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
