...
class AdminPanelModule102Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule102Create(AdminPanelModule102Base):
    pass

class AdminPanelModule102Response(AdminPanelModule102Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
