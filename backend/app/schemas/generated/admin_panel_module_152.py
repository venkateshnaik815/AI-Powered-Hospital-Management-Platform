...
class AdminPanelModule152Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule152Create(AdminPanelModule152Base):
    pass

class AdminPanelModule152Response(AdminPanelModule152Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
