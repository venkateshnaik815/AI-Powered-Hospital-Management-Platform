...
class AdminPanelModule125Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule125Create(AdminPanelModule125Base):
    pass

class AdminPanelModule125Response(AdminPanelModule125Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
