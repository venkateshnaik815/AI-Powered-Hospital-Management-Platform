...
class AdminPanelModule129Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule129Create(AdminPanelModule129Base):
    pass

class AdminPanelModule129Response(AdminPanelModule129Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
