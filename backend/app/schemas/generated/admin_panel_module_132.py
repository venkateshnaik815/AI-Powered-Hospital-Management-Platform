...
class AdminPanelModule132Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule132Create(AdminPanelModule132Base):
    pass

class AdminPanelModule132Response(AdminPanelModule132Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
