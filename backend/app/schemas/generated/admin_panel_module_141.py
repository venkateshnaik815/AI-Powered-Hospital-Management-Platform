...
class AdminPanelModule141Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule141Create(AdminPanelModule141Base):
    pass

class AdminPanelModule141Response(AdminPanelModule141Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
