...
class AdminPanelModule142Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule142Create(AdminPanelModule142Base):
    pass

class AdminPanelModule142Response(AdminPanelModule142Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
