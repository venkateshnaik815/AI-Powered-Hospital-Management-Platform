...
class AdminPanelModule153Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule153Create(AdminPanelModule153Base):
    pass

class AdminPanelModule153Response(AdminPanelModule153Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
