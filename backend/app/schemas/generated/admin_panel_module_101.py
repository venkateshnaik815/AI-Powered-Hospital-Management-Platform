...
class AdminPanelModule101Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule101Create(AdminPanelModule101Base):
    pass

class AdminPanelModule101Response(AdminPanelModule101Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
