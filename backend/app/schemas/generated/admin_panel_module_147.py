...
class AdminPanelModule147Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule147Create(AdminPanelModule147Base):
    pass

class AdminPanelModule147Response(AdminPanelModule147Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
