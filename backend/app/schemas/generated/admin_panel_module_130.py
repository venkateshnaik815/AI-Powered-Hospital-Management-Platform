...
class AdminPanelModule130Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule130Create(AdminPanelModule130Base):
    pass

class AdminPanelModule130Response(AdminPanelModule130Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
