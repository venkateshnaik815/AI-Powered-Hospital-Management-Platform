...
class AdminPanelModule113Base(BaseModel):
    is_active: bool = True
...
class AdminPanelModule113Create(AdminPanelModule113Base):
    pass

class AdminPanelModule113Response(AdminPanelModule113Base):
    id: int
    created_at: datetime
    updated_at: datetime
    class Config:
